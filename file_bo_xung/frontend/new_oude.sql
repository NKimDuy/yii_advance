...
-- Dumping data for table new_oude.tb_dan_toc: ~61 rows (approximately)
...
-- Dumping structure for table new_oude.tb_ho_so_sv
DROP TABLE IF EXISTS `tb_ho_so_sv`;
...
-- Dumping data for table new_oude.tb_ho_so_sv: ~0 rows (approximately)
...
-- Dumping structure for table new_oude.tb_sinh_vien
DROP TABLE IF EXISTS `tb_sinh_vien`;
...
-- Dumping data for table new_oude.tb_sinh_vien: ~2 rows (approximately)
...
-- Dumping structure for table new_oude.tb_sv_hk
DROP TABLE IF EXISTS `tb_sv_hk`;
...
-- Dumping data for table new_oude.tb_sv_hk: ~0 rows (approximately)
...
-- Dumping data for table new_oude.tb_tinh_trang_sv: ~1 rows (approximately)
